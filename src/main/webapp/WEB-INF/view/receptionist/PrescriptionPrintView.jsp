...
<script>
	...
	<div class="container"><br/>
		...
		<div class="row">
			...
			<div class="col-sm-7">
			<p><b>Dr. Sachin K Deore</b><br/> MBBS, DNB(Gen. Surgeon), MS</p>
			</div>
		</div>
		<hr/>
	<div class="demo">
			...
			<div>
				...
				<hr/>
				Our Centers:<br/>
			    1. Ojas Hospital, Andheri West, Mumbai, Maharashtra 400053 |
			    2. Ojas Hospital, Gangapur road, Nashik, Maharashtra 422005<br/>
			    Mobile No. 8087030000 | Phone No. 0253-2575151 | E-mail: drsachinkdeore@ojas.in	
			</div>	
